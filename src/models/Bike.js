...
function BikeModel(props) {
  const group = useRef();
    ...
    const fourthMesh= useRef();
    const chainMesh= useRef();
    const pedalMesh= useRef();


    useFrame((_, delta)=>{
        firstMesh.current.rotation.y-= delta*3;
        secondMesh.current.rotation.z-= delta*3;
        thirdMesh.current.rotation.y-= delta*3;
        fourthMesh.current.rotation.z-= delta*3;
        pedalMesh.current.rotation.z-= delta*3;
        // chainMesh.current.rotation.x+= delta;
        // chainMesh.current.rotation.y= 0;
        // chainMesh.current.rotation.z= 0;
  ...
  const { nodes, materials } = useGLTF("/bike/bike.gltf");
  return (
    <>
      <OrbitControls />
...
useGLTF.preload("/bike/bike.gltf");
